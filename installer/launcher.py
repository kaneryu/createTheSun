def run():
    ...
    class MainWindow(QMainWindow):
        ...
        def start(self):
            with open(f"{os.getenv('LOCALAPPDATA')}/createTheSun/launcherRan", "w") as f: #type: ignore
                f.write("True")
                
            subprocess.Popen([f"{os.getenv('LOCALAPPDATA')}/createTheSun/main.exe"]) #type: ignore
            self.close()
